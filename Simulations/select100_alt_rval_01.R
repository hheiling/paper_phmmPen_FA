...
r_input = combos[sim_num,"est_val"]
...
if(B_size == "moderate"){
  # B = B0 * 0.75
  B = B0 * 0.65 # Smaller constant to keep variances and eigenvalues closer to r=3 B matrix results
  cov_mat = B %*% t(B)
